...
//Get instructor's classrooms list
ClassroomRouter.get('/classrooms/:instructorId', async (req, res) =>{
    try {
        const classroomList = await Classroom.find({instructors : req.params.instructorId},'name  _id').exec();
        res.statusCode = 200;
